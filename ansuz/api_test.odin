...
test_api_predefined_styles :: proc(t: ^testing.T) {
	...
	testing.expect(t, style_normal().fg == Ansi.Default)
	testing.expect(t, style_bold().fg == Ansi.Default)
	testing.expect(t, style_dim().fg == Ansi.Default)
	testing.expect(t, style_underline().fg == Ansi.Default)

	testing.expect(t, style_error().fg == Ansi.Red)
	testing.expect(t, style_success().fg == Ansi.Green)
	testing.expect(t, style_warning().fg == Ansi.Yellow)
	testing.expect(t, style_info().fg == Ansi.Cyan)
}
