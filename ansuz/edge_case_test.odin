...
test_buffer_error_enum_values :: proc(t: ^testing.T) {
    ...
    testing.expect(t, BufferError.None != .InvalidDimensions, "Different errors should not be equal")
}
